sudo python3 -m pip install cmake user # (We need CMake >= 3.14. The day the ppa catches up, this can be replaced with `sudo apt install cmake`)
sudo python3 -m pip install cpplint user
