...
Track::Track(b2World& world) {
  ...
  walls.SetAsBox(40, 4.5, b2Vec2(0, 80), 0);//ceiling
  track->CreateFixture(&fixture);
  walls.SetAsBox(4.5, 40, b2Vec2(-40, 40), 0);//left wall
  track->CreateFixture(&fixture);
  walls.SetAsBox(4.5, 40, b2Vec2(40, 40), 0);//right wall
  track->CreateFixture(&fixture);

  b2CircleShape edge1;//down left edge
  edge1.m_p.Set(-40.0f, 0.0f);
  edge1.m_radius = 4.5f;
